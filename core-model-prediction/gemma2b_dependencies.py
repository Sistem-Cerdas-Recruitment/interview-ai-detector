...
class Gemma2BDependencies:
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            cls._instance.tokenizer = AutoTokenizer.from_pretrained("google/gemma-2b", token=token)
            cls._instance.model = AutoModelForCausalLM.from_pretrained("google/gemma-2b", token=token)
    ...
    def access_hf_token_secret(self):
        ...
        name = "projects/vocal-collector-431514-m7/secrets/HF_TOKEN/versions/1"
